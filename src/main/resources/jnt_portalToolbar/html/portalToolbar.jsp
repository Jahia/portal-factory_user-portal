        ...
        <div id="portal_toolbar" class="portal_toolbar">
            <div>
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#newTabModal" class="toolbar-tooltip" data-placement="bottom"
                           title="<fmt:message key="jnt_portalToolbar.addTab.tooltip"/>">
                    ...
                    <li class="right"><a href="#editTabModal" data-toggle="modal"
                                         ...
                                         title="<fmt:message key="jnt_portalToolbar.editTab.tooltip"/>"><i
